...
<head>
    ...
    <link rel="icon" href="../assets/img/person-digging-solid.png">

    <title>Sistem Penggunaan Dana Proyek - PT Cipta Karya Bagus</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SIPD</div>
            </a>
